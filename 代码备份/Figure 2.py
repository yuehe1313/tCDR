...
dir_path = '/Users/heyue/Documents/D/科研相关/我的/tCDR/tCDR'
os.chdir(dir_path)
...
for i in np.arange(0,8):
    ...
    if i == 0:
        ...
        title_line1 = r'$\alpha$ kg CO$_2$ of tCDR to offset 1 kg CH$_4$ (biogenic)'
        title_line2 = r'(lifetime: 11.8 years, GWP$_{{100}}$: 27)'    
    ...
    if i == 1:
        ...
        title_line1 = r'$\alpha$ kg CO$_2$ of tCDR to offset 1 kg CH$_4$ (fossil)'
        title_line2 = r'(lifetime: 11.8 years, GWP$_{{100}}$: 30)'  
...
# AGWPCH4NonFossil_Final_partial(t=100, AANonCO2=AACH4, tauNonCO2=tauCH4)/AGWPCO2_partial(t=100)

# AGWPCH4Fossil_Final_partial(t=100, AANonCO2=AACH4, tauNonCO2=tauCH4)/AGWPCO2_partial(t=100)
