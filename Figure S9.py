...
plt.savefig('figure/Figure S9.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
plt.savefig('figure/Figure S9.pdf', bbox_inches='tight', pad_inches=0.1)
